...
emails_lista = [base_emails.strip() for base_emails in base_emails.split(",")]

# Dicionario para contar qtos e-mails por dominio
dominios_count = {}
...
for email in emails_lista:
    # Separa nome de usuario e dominio
...
# converter a lista de usuario para tupla
    usuarios_tupla = tuple(usuarios)
    # trocar primeiro e o ultimo usuario para tupla
    usuarios_tupla_invertido = list(usuarios_tupla)
    usuarios_tupla_invertido[0], usuarios_tupla_invertido[-1] = usuarios_tupla_invertido[-1], usuarios_tupla_invertido
    ...
    print("\nRelatório")
    print("Quantidade de e-mails por dominio: ")
